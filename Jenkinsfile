       ...
       stage('Deploy') {
            ...
            sshPublisher(publishers: [
                sshPublisherDesc(configName: 'deployment-server', transfers: [
                    ...
                    sshTransfer(cleanRemote: false, excludes: '', execCommand: 'ls && chmod +x add2vals && bash add2vals 2 5 && bash 5', execTimeout: 120000, flatten: false, makeEmptyDirs: false, remoteDirectory: 'dicoding-ci-cd/dist', remoteDirectorySDF: false, removePrefix: '', sourceFiles: '')
